(() => {
  ...
  style.textContent = `
    ...
    .competency-badges-note{margin:8px 0 13px;font-size:10px!important;line-height:1.45;color:#607486!important}.competency-badges-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.competency-badge-card{position:relative;min-width:0;padding:8px 5px 9px;text-align:center;border-radius:15px;border:1px solid #dce9eb;background:rgba(255,255,255,.9);transition:transform .2s ease,box-shadow .2s ease}.competency-badge-card.is-earned{border-color:rgba(0,123,133,.26);box-shadow:0 6px 16px rgba(0,123,133,.1)}.competency-badge-card.is-earned:active{transform:scale(.97)}
    .competency-badge-art{position:relative;width:64px;height:74px;margin:0 auto 5px}.competency-badge-art img{display:block;width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 5px 5px rgba(0,32,91,.18))}.competency-badge-card.is-locked .competency-badge-art img{filter:grayscale(1);opacity:.2}.competency-badge-check,.competency-badge-lock{position:absolute;right:-3px;bottom:1px;display:grid;place-items:center;width:20px;height:20px;border-radius:50%;font-size:8px}.competency-badge-check{color:#fff;background:#70ad47;border:2px solid #fff;box-shadow:0 3px 8px rgba(50,100,30,.3)}.competency-badge-lock{color:#81909b;background:#edf2f4;border:2px solid #fff}
    .competency-badge-card h4{margin:0;font-size:9px;line-height:1.2;font-weight:900;color:#00205b;min-height:22px}.competency-badge-card p{margin:3px 0 0!important;font-size:8px!important;line-height:1.2!important;color:#667b89!important}.competency-badge-card time{display:block;margin-top:3px;font-size:7px;font-weight:800;text-transform:uppercase;color:#007b85}.competency-badge-card.is-locked h4{color:#71818c}
    @media(max-width:360px){.competency-badges-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.competency-badge-art{width:70px;height:80px}}
  `;
